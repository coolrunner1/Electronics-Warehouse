...
UPDATE ClientOrder SET status = 'Delivered' WHERE order_id = 4;
...
FROM Item JOIN OrderProduct ON Item.item_id = OrderProduct.item_id WHERE OrderProduct.order_id = 1;
