...
INSERT INTO Item (category_id, model, status, manufacturer, unit_price, date_of_arrival, units_in_stock, faulty_units) VALUES
(1, 'Smartphone X', 'In Stock', 'ABC Electronics', 599.99, 20220101, 100, 2),
(2, 'Laptop 10', 'In Stock', 'Laptops inc.', 19.99, 20220115, 50, 0);
